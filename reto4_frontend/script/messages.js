...
function obtener() {
  ...
  fetch(`${GlobalHost}/api/Message/all`, requestOptions)
      ...
      result.forEach((element) => {
        tableBody.innerHTML += `
                <tr>
                    ...
                    <td>
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modal" onclick="btnDetails(${element.idMessage})">
                            Details
                        </button>
                    </td>
                </tr>
...
function obtenerPorId(id) {
  ...
  fetch(`${GlobalHost}/api/Message/${id}`, requestOptions)
    .then((response) => response.json())
    .then((result) => {
...
function eliminar() {
  ...
  fetch(`${GlobalHost}/api/Message/${inputId.value}`, requestOptions)
...
function actualizar() {
  ...
  fetch(`${GlobalHost}/api/Message/update`, requestOptions)
    .then((response) => {
...
function crear() {
  ...
  fetch(`${GlobalHost}/api/Message/save`, requestOptions)
    .then((response) => {
      window.location.reload();
    })
    .catch((error) => console.log("error", error));
