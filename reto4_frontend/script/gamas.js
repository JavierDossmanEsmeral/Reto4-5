...
function crear() {
  ...
  fetch(`${GlobalHost}/api/Gama/save`, requestOptions)
    .then((response) => {
...
function obtenerPorId(id) {
  ...
  fetch(`${GlobalHost}/api/Gama/${id}`, requestOptions)
    .then((response) => response.json())
    .then((result) => {
      if (result) {
...
function eliminarPorId() {
  ...
  fetch(`${GlobalHost}/api/Gama/${inputId.value}`, requestOptions)
    .then((response) => {
      console.log(response);
      window.location.reload();
    })
...
function actualizarPorId() {
  ...
  fetch(`${GlobalHost}/api/Gama/update`, requestOptions)
    .then((response) => {
      console.log(response);
      window.location.reload();
    })
