...
function crear() {
  ...
  fetch(`${GlobalHost}/api/Client/save`, requestOptions)
    .then((response) => {
...
function obtenerPorId(id) {
  ...
  fetch(`${GlobalHost}/api/Client/${id}`, requestOptions)
    .then((response) => response.json())
    .then((result) => {
      if (result) {
...
function eliminarPorId() {
  ...
  fetch(`${GlobalHost}/api/Client/${inputId.value}`, requestOptions)
    .then((response) => {
      console.log(response);
      window.location.reload();
    })
...
function actualizarPorId() {
  ...
  fetch(`${GlobalHost}/api/Client/update`, requestOptions)
    .then((response) => {
      console.log(response);
      window.location.reload();
    })
